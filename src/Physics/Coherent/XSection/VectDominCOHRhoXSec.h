...
\class    genie::VectDominCOHRhoXSec
...
#ifndef _VECT_DOMIN_COHRHO_PXSEC_H_
#define _VECT_DOMIN_COHRHO_PXSEC_H_
...
class VectDominCOHRhoXSec : public XSecAlgorithmI {

public:
  VectDominCOHRhoXSec();
  VectDominCOHRhoXSec(string config);
  virtual ~VectDominCOHRhoXSec();
...
#endif  // _VECT_DOMIN_COHRHO_PXSEC_H_
